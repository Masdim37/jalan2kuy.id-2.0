...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/tikets/tiketprint.css') }}">
...
<body>
    ...
    <div class="container" style="padding: 100px 20px; min-height: 80vh; max-width: 900px; margin: 0 auto;">
        <h2 class="ticket-title">{{ $tiket->event->name ?? 'Nama Event Tidak Tersedia' }}</h2>
            ...
            <div class="ticket-card" style="background: white; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.08); margin-bottom: 20px; display: flex; overflow: hidden; border-left: 6px solid #16c4b0;">
                ...
                <div class: ticket-left style="padding: 20px; flex: 1;">
                    
                    <p style="margin: 5px 0; color: #555; font-size: 20px; font-weight: bold;">Status Tiket</p>
                    <p style="margin: 5px 0; color: black; font-size: 20px; font-weight: bold; margin-bottom: 15px;">Aktif</p>
                ...
                <div class: ticket-right style=" background: #fdfdfd; border-left: 2px dashed #ddd; display: flex; flex-direction: column; justify-content: center; align-items: center; min-width: 180px; text-align: center;">
                    ...
                    @if($tiket->tiketStatus == 1)
                        ...
                        <div style="font-size: 12px; color: black; font-weight: bold; font-size: 20px; text-transform: uppercase;">{{ $tiket->tiketID }}</div>
