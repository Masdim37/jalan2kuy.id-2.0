    ...
    <div class="main-wrapper-content">
        <div class="content-area">
            ...
            <div class="profile-card">
                <div class="info-item"><strong>Nama:</strong> {{ $user->nameUser }}</div>
                ...
                <!-- Tombol aksi akun -->
                <button class="action-btn edit-btn" id="editProfileButton" onclick="window.location.href='{{ url('/Edit-Profile') }}'">Edit Profile</button>
