    ...
    <section class="hero">
        ...
        <div class="hero-top">
            ...
            <div class="action-btn">
                ...
                <a href="{{ url('/admin/Destination/Edit/' . $destination->destinationID) }}" class="edit-btn"
                    style="text-decoration: none; display:inline-block; text-align:center;">Edit</a>
        ...
        <div class="content-box">
            ...
            <div class="image-box">
                ...
                <p id="time">
                    ...
                    ({{ \Carbon\Carbon::parse($destination->openingHours)->format('H:i') }} -
                    {{ \Carbon\Carbon::parse($destination->closingHours)->format('H:i') }}
                ...
                <div id="eventBox">
                    ...
                    @if ($events->count() > 0)
                        ...
                        @foreach ($events as $event)
                            <a class="event-link" href="{{ url('/admin/Event/Detail/' . $event->eventID) }}"
        ...
        <div id="deletePopup" class="popup-overlay" style="display: none;">
            <div class="popup-box">
                ...
                <div class="popup-buttons">
                    ...
                    <form action="{{ url('/admin/Destination/Delete/' . $destination->destinationID) }}" method="POST"
